...
VAPE_WORDS = [
    "전자담배", "전담", "액상", "니코틴", "궐련형", "액상형",
    "베이프", "vape", "담배사업법", "폐호흡", "입호흡",
    "카트리지", "무니코틴", "합성니코틴", "기화기", "전담샵",
]
...
ISSUE_WORDS = [
    "부작용", "유해", "위해", "독성", "발암", "중독", "금단",
    "논란", "우려", "경고", "주의", "위험", "안전성", "실태",
    "규제", "단속", "금지", "제재", "과태료", "처분", "고발", "소송",
    "검출", "회수", "리콜", "기준", "표시 의무", "성분 분석", "연구",
    "청소년", "폐 손상", "호흡기", "기침", "구토", "두통", "어지럼",
    "가향", "향료", "첨가물", "허위", "과장 광고",
]
...
GROUPS = [
    ...
    },
    {
        ...
        "drop_politics": False,
        "require_any": VAPE_WORDS + ["코일", "누유", "팟"],
        "alert": False,
    },
    {
        "id": "brand",
